...
class resultClass:
    def __init__(self,root):
        ...
        self.root.geometry("1200x480+50+170")  
        self.root.config(bg="white")
        self.root.focus_force()
        #===title====
        title=Label(self.root,text="Add Student Result",font=("goudy old style",20,"bold"),bg="orange",fg="#262626").place(x=10,y=15,width=1180,height=40)
        # ================Widgets===================
        ...
        lbl_select=Label(self.root,text="Select Student :", font=("goudy old style",18,"bold"),bg="white").place(x=50, y=100)
        ...
        lbl_marks=Label(self.root,text="Marks Obtained :", font=("goudy old style",18,"bold"),bg="white").place(x=50, y=280)
        ...
        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style", 18,'bold'),bg='lightyellow',state='readonly').place(x=280,y=160,width=320)
        txt_course=Entry(self.root,textvariable=self.var_course,font=("goudy old style", 18,'bold'),bg='lightyellow',state='readonly').place(x=280,y=220,width=320)
        txt_marks=Entry(self.root,textvariable=self.var_marks,font=("goudy old style", 18,'bold'),bg='lightyellow').place(x=280,y=280,width=320)
        txt_full_marks=Entry(self.root,textvariable=self.var_full_marks,font=("goudy old style", 18,'bold'),bg='lightyellow').place(x=280,y=340,width=320)
