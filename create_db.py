...
def create_db():
    ...
    cur.execute("CREATE TABLE IF NOT EXISTS register(reg_id INTEGER PRIMARY KEY AUTOINCREMENT,f_name text,l_name text,contact text,email text,question text,answer text,password text)")
    con.commit()
