...
class studentClass:
    def __init__(self,root):
       ...
       #================= Column 2==================
        ...
        lbl_admiss=Label(self.root,text="Admission:",font=("goudy old style", 15,'bold'),bg='white').place(x=370,y=140)
        lbl_course=Label(self.root,text="Course:",font=("goudy old style", 15,'bold'),bg='white').place(x=370,y=180)
       
       
       
       #====EntryFields======
        self.course_list=["C","C++","Java","Python","AI&ML","SQL","Full Stack","Data Structures"]
        ...
        txt_admiss=Entry(self.root,textvariable=self.var_a_date,font=("goudy old style", 15,'bold'),bg='lightyellow').place(x=480,y=140,width=200)
       ...
       #========Text Address==============
        ...
        self.CourseTable=ttk.Treeview(self.C_Frame,columns=("roll","name","email","gender","dob","contact","a_date","course","state","city","pin","address"),xscrollcommand=scrollx.set,yscrollcommand=scrolly.set)
        ...
        self.CourseTable.heading("a_date",text="Admission")
        ...
        self.CourseTable.column("a_date",width=100)
    ...
    def remove(self):
        ...
        try:
            ...
            for row in rows:
                self.CourseTable.insert('',END,values=row)
            messagebox.showinfo("Success","Student Details are cleard !!",parent=self.root)
        except Exception as ex:
            messagebox.showerror("Error",f"Error due to {str(ex)}")
